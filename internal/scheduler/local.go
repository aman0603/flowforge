...
// service. This seam lets Phase 11 extract the scheduler without changing
...
// LocalClient implements Client using the repository directly. It preserves the
// pre-Phase-11 in-process behavior when no gRPC scheduler is configured.
